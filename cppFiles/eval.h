#ifndef __EVAL__
#define __EVAL__
// From pesto evaluation from chess wiki
...
class Eval{
	...
	static constexpr int gamephaseInc[12] = {0,0,1,1,1,1,2,2,4,4,0,0};
	static vector<vector<int>> mg_table;
	static vector<vector<int>> eg_table;
	...
	static constexpr const int* mg_pesto_table[6] =
	{
		mg_pawn_table,
		mg_knight_table,
		mg_bishop_table,
	...
	static constexpr const int* eg_pesto_table[6] =
	{
		eg_pawn_table,
		eg_knight_table,
		eg_bishop_table,
